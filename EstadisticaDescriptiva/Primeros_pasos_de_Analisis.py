...
df_ventas = pd.read_excel('C:/Users/pulga/Desktop/6IV7_RUEDA_GUTIERREZ_ADRIAN_EVERARDO_ANALISIS-main/EstadisticaDescriptiva/proyecto1.xlsx')
...
df_sucursal = pd.read_excel('./EstadisticaDescriptiva/Catalogo_sucursal.xlsx')
...
#Cuanto es el porcentaje de utilidad del comercio a partir de el total
#de las ventas respecto del adeudo
